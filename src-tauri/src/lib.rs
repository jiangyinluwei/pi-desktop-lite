...
// ==========================================================================
// Flow 会话回退 — 历史节点回退 + 文件撤回链路 (与内核原生 fork 配合)
// ==========================================================================
...
async fn pi_rollback_files(
    ...
    rollback::rollback_files(&session_id, &targets, dry_run.unwrap_or(false))
}
